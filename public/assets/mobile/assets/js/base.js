...
//-----------------------------------------------------------------------
// Upload Input
var uploadComponents = document.querySelectorAll('.custom-file-upload');

uploadComponents.forEach(function (uploadComponent) {
    var fileInput = uploadComponent.querySelector('input[type="file"]');
    var fileLabel = uploadComponent.querySelector('label');
    var fileLabelText = uploadComponent.querySelector('label span');
