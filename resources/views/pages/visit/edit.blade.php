...
<div class="col-12">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Visit Client</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('visit.update', $edit->id) }}">
                @csrf
                @method('PUT')
                <div class="row g-2">
                    <div class="col-md-4">
                        ...
                        <select name="client_id" id="client_id" class="form-select select2" required>
                            <option value="{{ $edit->nama_perusahaaan }}">{{ $edit->nama_perusahaaan }}</option>
                            @foreach ($cus as $item)
                    ...
                    <div class="col-md-4">
                        ...
                        <textarea name="lokasi" class="form-control" id="" cols="0" rows="0"
                            placeholder="Enter">{{ $edit->lokasi }}</textarea>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="agenda" placeholder="Enter"
                            value="{{ $edit->agenda }}" required>
                    </div>
                    <div class="col-md-4">
                        <label for="jam" class="form-label">Jam Visit</label>
                        <input type="time" class="form-control" name="jam" placeholder="Enter" value="{{ $edit->jam }}"
                            required>
                    </div>
                    <div class="col-md-4">
                        <label for="jam_selesai" class="form-label">Jam Selesai</label>
                        <input type="time" class="form-control" name="jam_selesai" placeholder="Enter"
                            value="{{ $edit->jam_selesai }}" required>
                    </div>
                    <div class="col-md-4">
                        <label for="nama_visitor" class="form-label">Nama Visitor</label>
                        {{-- <input type="text" class="form-control" name="nama_visitor" placeholder="Enter"
                            value="{{ $edit->nama_visitor }}" required> --}}
                    ...
                    <div class="col-md-4">
                        ...
                        @php
                        $atten =\App\Models\Attendance::where('vi_number', $edit->vi_number)->get()
                        @endphp
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="result" placeholder="Enter"
                            value="{{ $edit->result }}" required>
                    </div>
                    <div class="col-md-4">
                        <label for="fo_1" class="form-label">Follow Up 1</label>
                        <input type="text" class="form-control" name="fo_1" placeholder="Enter"
                            value="{{ $edit->fo_1 }}" required>
                    </div>
                    <div class="col-md-4">
