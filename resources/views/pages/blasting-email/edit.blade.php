<form method="POST" action="{{ route('blasting-email.update', $edit->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="modal-body">
        <div class="row g-2 mb-3">
            ...
            <div class="col-md-3">
                <a href="{{ route('blasting-email.index') }}" class="  btn btn-label-secondary me-2 mt-4">
                    Back
                </a>
