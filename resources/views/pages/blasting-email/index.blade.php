...
@section('title', 'New Blasting Email')
        ...
        <div class="card-body">
            <div class="row ">
                <div class="col-auto me-auto ">
                    @if (isset($edit))
                    <h5 class="mb-0">Edit New Blasting Email</h5>
                    @else
                    <h5 class="mb-0">Tambah New Blasting Email</h5>
                    @endif
                </div>
                <div class="card-body">
                    @if (isset($edit))
                    @include('pages.blasting-email.edit')
                    @else
                    @include('pages.blasting-email.create')
                    @endif
                </div>
            </div>
        </div>
...
<div class="col-xs-12 col-sm-12 col-md-12">
    <div class="card">
        <div class="card-body">
            <div class="row ">
                <div class="col-auto me-auto ">
                    <h5 class="mb-0">Data New Blasting Email</h5>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <form method="POST" action="{{ route('blasting-email.destroy', $item->id) }}">
                                    @csrf
                                    @can('blasting-email.edit')
                                    <a href="{{ route('blasting-email.edit', $item->id) }}"
                                        class="btn btn-icon btn-warning btn-sm">
                                        <span class="ti ti-edit"></span>
                                    </a>
                                    @endcan

                                    @can('blasting-email.delete')
